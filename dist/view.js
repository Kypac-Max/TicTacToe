...
var _View_instances, _View_handlePlayerMove, _View_setTurnIndicator, _View_updateScoreBoard, _View_openModal, _View_closeAll, _View_clearMoves, _View_initializeMoves, _View_closeModal, _View_closeMenu, _View_toggleMenu, _View_qs, _View_qsAll, _View_delegate;
...
export default class View {
    constructor() {
        ...
        this.$.p1Stats = __classPrivateFieldGet(this, _View_instances, "m", _View_qs).call(this, '[data-id="p1-stats"]');
        this.$.p2Stats = __classPrivateFieldGet(this, _View_instances, "m", _View_qs).call(this, '[data-id="p2-stats"]');
    ...
    render(game, stats) {
        ...
        __classPrivateFieldGet(this, _View_instances, "m", _View_initializeMoves).call(this, currentGameMoves);
        if (isComplete) {
...
_View_instances = new WeakSet(), _View_handlePlayerMove = function _View_handlePlayerMove(squareEl, player) {
...
}, _View_updateScoreBoard = function _View_updateScoreBoard(p1Stats, p2Stats, ties) {
